...
- 节点别名增强：优选节点会基于真实 IP 归属地增加地区前缀，例如 `🇸🇬新加坡-优选域名-01`、`🇯🇵日本-IPv6优选-02`
...
- 会先解析域名到真实 IP，再基于真实 IP 归属地生成地区前缀
- 域名节点：`🇸🇬新加坡-优选域名-01`、`🇭🇰香港-优选域名-02`
- IPv6节点：`🇯🇵日本-IPv6优选-01`、`🇺🇸美国-IPv6优选-02`
- IPv4节点：优先使用 `🇭🇰香港-isp-colo-序号`，缺少运营商信息时回退为 `🇩🇪德国-IPv4优选-序号`
- 当归属地查询失败时会自动回退到原命名格式，不阻断订阅生成
